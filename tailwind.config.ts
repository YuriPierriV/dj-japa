...
export default {
  ...
  theme: {
    ...
    extend: {
      colors: {
        'neon-red': '#FF1744',
        // Tema Japonês Moderno
        japan: {
          red: "#E60012", // Vermelho da bandeira japonesa
          purple: "#6B46C1", // Roxo neon
          pink: "#EC4899", // Rosa neon
          blue: "#3B82F6", // Azul neon
          cyan: "#06B6D4", // Ciano neon
          dark: "#0F172A", // Azul escuro japonês
          gray: "#1E293B", // Cinza escuro
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(16, 215, 255, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(16, 215, 255, 0.6)" },
        },
        "pulse-neon": {
