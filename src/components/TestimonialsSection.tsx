...
const testimonials = landingImages.storiesArchive.items;
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-20">
          ...
          <h2 className="font-serif text-4xl lg:text-5xl font-medium text-wedding-navy leading-tight">
            Memórias de <span className="italic font-bold">Noites Inesquecíveis</span>
          </h2>
        </div>
          ...
          {testimonials.map((item, index) => (
            ...
            >
              ...
              <div className="p-8 sm:p-10 flex flex-col flex-1 relative bg-wedding-white">
                ...
                <p className="text-wedding-navy font-medium italic text-lg leading-relaxed relative z-10 mt-2 mb-8 flex-1">
                  &ldquo;{item.text}&rdquo;
                </p>
                <div className="flex items-center gap-4 mt-auto">
                  <div className="w-8 h-[2px] bg-wedding-gold/60"></div>
                  <span className="font-serif text-wedding-navy text-xl font-bold">{item.name}</span>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        <div className="flex justify-center mt-16">
          <a href="#contato" className="inline-flex items-center justify-center rounded-sm border border-wedding-navy bg-transparent px-10 py-5 font-serif text-sm uppercase tracking-[0.2em] text-wedding-navy transition-all duration-300 hover:bg-wedding-navy hover:text-wedding-white">
